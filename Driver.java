...
//        System.out.println("Hearts has been broken!");
    ...
    public static Card playTurn( Player m ) {
            for (int x = 0; x< 1200000000; x++){}/// wanted to find a way to have each turn take a little longer, this is all i could think of
    ...
    public static void main(String [] args){
        ...
        System.out.println("Would you like to read a tutorial? [If so, type 'a' then hit 'enter'. If not, press 'enter'.]");
